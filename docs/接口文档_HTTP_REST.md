...
### 3.2 规则
#### `GET /qc/rules`
返回内置规则目录（性别矛盾 R1 / 左右混淆 R2 / 评分缺失 R3 / 单位错误 R4 / 描述-结论矛盾 R5 / 登记部位不符 R6 / 错别字 R8 / 互斥冲突 R9 / 模板规范 R10 / 句子逻辑 R12 / 前后文 R14 / 上下文 R15 / 逐部位 R17 / 部位漏写 R18 / 形近错字 R19 / …），含分类与默认严重度。R7/R11/R13/R20 已合并或预留，不再单列。
