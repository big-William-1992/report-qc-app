"""
engine_meta.py — 元信息自动抽取（P2 拆分自 engine.py）
====================================================
从报告正文抽取 患者姓名/影像号/性别/年龄/检查方式/登记部位/侧别，
用于剪贴板/导入场景自动回填输入框。抽取结果仅作提示，允许人工校正。

依赖：_lexicons（MODALITY_SCORE/SITE_NORM/SITE_CANON/LATERALITY）、
engine_helpers._parse_gender_from_text。无反向依赖。
"""
import re

from _lexicons import *  # noqa: F401,F403

from engine_helpers import _parse_gender_from_text
